...
let somePosts: [Post] = [
    Post(text: "Какой-то очень интересный пост.", attachments: somePhotos, likeCount: 50, viewCount: 697),
    Post(text: "Ещё более интересный пост.", attachments: somePhotos.dropLast(), likeCount: 107, viewCount: 1012),
    Post(text: "Не очень интересный пост.", attachments: [somePhotos[1]], likeCount: 25, viewCount: 273)
]
